...
# this call causes the stall issue

HOST_LC_CHOICE = (('whatever','whatever'),('whatever2', 'whatever2'))
...
class Ep(models.Model):
    ...
    ticket_id = models.OneToOneField(Ticket, on_delete=models.CASCADE, primary_key=True)
...
class Filler(models.Model):
    ...
    filler_name = models.CharField(max_length=128, blank=False, null=False, help_text="Enter Your Full Name.")
    filler_email = models.EmailField(blank=False, null=False)
    filler_lc = models.CharField(max_length=1, blank=False, null=True, choices=HOST_LC_CHOICE)
    filler_position = models.CharField(max_length=1, blank=False, null=True, choices=POSITION_CHOICE)
    filler_role = models.CharField(max_length=1, blank=True, null=True, choices=ROLE_CHOICE)
